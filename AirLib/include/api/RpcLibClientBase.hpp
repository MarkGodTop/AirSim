...
namespace airlib
{
    ...
    public:
         ...
         *  使用者上传数据接口
         */
        void simUpdateLocalPositionData(const std::string vehicle_name = "",float locX=0.0f,float locY=0.0f,float locZ=0.0f,int64_t timeStamp=0,int opFlag=8);//默认全局定位准确度
        void simUpdateLocalRotationData(const std::string vehicle_name = "",float quatW=0.0f,float quatX=0.0f,float quatY=0.0f,float quatZ=0.0f,int64_t timeStamp=0);
        void simUpdateLocalDefaultVelocityData(const std::string vehicle_name = "",float velocity=0.0f);
        void simUpdateLocalDetectTargetNumData(const std::string vehicle_name = "",const std::string jsonData = "");
        void simUpdateLocalTargetDistanceData(const std::string vehicle_name = "",float targetDistance=0.0f,float targetPosX=0.0f,float targetPosY=0.0f,float targetPosZ=0.0f,int targetType=0,bool bIsDynamic=false);
        void simUpdateLocalDetectTargetPreData(const std::string vehicle_name = "",float targetPosX=0.0f,float targetPosY=0.0f,float targetPosZ=0.0f,int targetType=0);
