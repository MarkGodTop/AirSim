...
#weather
    ...
    def simGetUEWeatherType(self):
        """
        Get weather type from ue world

        Returns:
            Type of WorldSimApiBase::UEWeatherType value
        """
        return self.client.call('simGetUEWeatherType')
...
#Recording APIs
    ...
    def simSpawnProjectile(self, vehicle_name, z_angle):
        self.client.call("simSpawnProjectile", vehicle_name, z_angle)

    def simTeleportTo(self,vehicle_name,locX,locY,locZ,rotPitch,rotYaw,rotRoll):
        """
        Teleport Vehicle to target point
        Args:
            vehicle_name: <std::string> The name of vehicle (VehicleInfo.json)
            locX,locY,locZ (float) 
            rotPitch,rotYaw,rotRoll (float)
            
        Returns:
            void
        """
        self.client.call("simTeleportTo",vehicle_name,locX,locY,locZ,rotPitch,rotYaw,rotRoll)

    def simUpdateLocalPositionData(self, vehicle_name, locX, locY, locZ, timeStamp, opFlag):
        """
        上传坐标值
        :param vehicle_name: 
        :param locX: 
        ...
        :return: 
        """
        self.client.call("simUpdateLocalPositionData",vehicle_name,locX,locY,locZ,timeStamp,opFlag)
        
    def simUpdateLocalRotationData(self, vehicle_name, quatW, quatX, quatY, quatZ, timeStamp):
        """
        上传旋转值
        :param vehicle_name: 
        :param quatW: 
        ...
        :return: 
        """
        self.client.call("simUpdateLocalRotationData",vehicle_name,quatW,quatX,quatY,quatZ,timeStamp)
       
    def simUpdateLocalDefaultVelocityData(self,vehicle_name,velocity):
        """
        上传设定速度值
        :param vehicle_name: 
        :param velocity: 
        :return: 
        """
        self.client.call("simUpdateLocalDefaultVelocityData",vehicle_name,velocity)
        
    def simUpdateLocalDetectTargetNumData(self,vehicle_name,jsondata):
        """
        上传目标检测结果
        :param vehicle_name: 
        :param jsondata: 
        :return: 
        """        
        self.client.call("simUpdateLocalDetectTargetNumData",vehicle_name,jsondata)
        
    def simUpdateLocalTargetDistanceData(self,vehicle_name,targetDistance,targetPosX,targetPosY,targetPosZ,targetType,bIsDynamic):
        """
        上传测算出的目标距离
        :param vehicle_name: 装备名称 
        :param targetDistance: 目标物距离
        :param targetPosX: 目标X坐标值
        :param targetPosY: 目标Y坐标值
        :param targetPosZ: 目标Z坐标值
        :param targetType: 目标物类型（同识别接口）
        :param bIsDynamic: true-动态测距 false-动态测距
        :return: 
        """
        self.client.call("simUpdateLocalTargetDistanceData",vehicle_name,targetDistance,targetPosX,targetPosY,targetPosZ,targetType,bIsDynamic)
        
    def simUpdateLocalPreDetectTargetData(self,vehicle_name,targetPosX,targetPosY,targetPosZ,targetType):
        """
        :param vehicle_name: 装备名称 
        :param targetPosX: 目标X坐标值
        :param targetPosY: 目标Y坐标值
        ...
        :return: 
        """
        self.client.call("simUpdateLocalDetectTargetPreData",vehicle_name,targetPosX,targetPosY,targetPosZ,targetType)
        
    def simFireNavMissile(self,vehicle_name,targetLocX,targetLocY,targetLocZ,bIsRemoteAttack):
        self.client.call("simFireNavMissile",vehicle_name,targetLocX,targetLocY,targetLocZ,bIsRemoteAttack)

    def simGetProjectileAmount(self, vehicle_name):
        return self.client.call("simGetProjectileAmount", vehicle_name)
        
    def simSingleLineTraceAttack(self, vehicle_name, z_angle):
        self.client.call("simSingleLineTraceAttack",vehicle_name,z_angle)
        
    def simGetSingleLineTraceAttackAmmo(self, vehicle_name):
        return self.client.call("simGetSingleLineTraceAttackAmmo",vehicle_name)
        
    def simIsVehicleAlive(self, vehicle_name):
        return self.client.call("simIsVehicleAlive", vehicle_name)

    def simGetHitBucketTimes(self, vehicle_name):
        return self.client.call("simGetHitBucketTimes", vehicle_name)
